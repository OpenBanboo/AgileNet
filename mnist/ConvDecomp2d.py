...
class ConvDecomp2d(nn.Module):
    def __init__(self, coefs, dictionary, bias_val, input_channels, output_channels, kernel_size, bias=True, is_dic_grad=False, is_coef_grad=False, is_bias_grad=False):
