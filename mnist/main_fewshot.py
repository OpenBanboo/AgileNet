...
parser.add_argument('--epochs_fewshot', type=int, default=20, metavar='N',
...
=========================================================================================
'''
def train(model_train=None, data_loader=None, epoch=1, num_batch=844, is_fewshot_dic_train=False):
    '''
