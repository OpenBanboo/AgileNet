...
class Generator(data.Dataset):
    def __init__(self, root, args, partition='train', dataset='omniglot',transform=None, shot=1, way=5 , fewshot=False, with_train=False, data_aug=False):
        self.root = root
