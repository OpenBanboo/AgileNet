...
class CIFAR10(data.Dataset):
    ...
    def __init__(self, root, train=True,
        ...
        if self.train:
            ...
            remove_mask_train = [(el==self.get_rid_of) for el in train_labels_temp]
            print("Train Dataset: exlude label ", self.get_rid_of)
            for el in range(len(remove_mask_train)):
                if remove_mask_train[el] is False:
                    num_keep_train += 1
            ...
            remove_mask_train = [(el==self.get_rid_of) for el in test_labels_temp]
            print("Test Dataset: exclude label ", self.get_rid_of)
            for el in range(len(remove_mask_train)):
                if remove_mask_train[el] is False:
                    num_keep += 1
