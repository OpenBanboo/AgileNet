...
class _BatchNorm(Module):
    ...
    def __init__(self, num_features, eps=1e-5, momentum=0.1, affine=True, weight=None, bias=None, running_mean=None, running_var=None):
